...
public class Evaluation {
	...
	public static final String mobinHTMLCharDetStat = "Statistics of Mobin HTMLCharDet";
	...
	public void setUp() throws Exception {
		...
		detectedCharsetStat.put(mobinHTMLCharDetStat, new ConcurrentHashMap<String, Integer>());
	}
