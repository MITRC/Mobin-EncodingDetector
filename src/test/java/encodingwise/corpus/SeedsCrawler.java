...
public class SeedsCrawler {
	...
	public void crawl() throws InterruptedException {
		...
		for (int i = 0; i < numOfThreads; i++) {
			SeedsCrawlThread thread = new SeedsCrawlThread("crawlerThread" + i, seedQueue, charsetStat, fetchedURLs,
					specialChrset);
	...
	/**
	 * The following methods puts proper URLs into seeds queue
	 * 
	 * These URLs are taken from:
